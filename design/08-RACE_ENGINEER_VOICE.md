...
| ---------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------- | -------- |
| `SessionStartGreeting` | First ON_TRACK tick of the session (fires once) | Race: "Clutch paddle in position. You start on {compound}s. Settle in, we'll talk strategy." (see per-session greetings below) | NORMAL   | All      |
...
| `CarAhead`                     | Gap to car ahead drops below 1.0 s (DRS range, first crossing). Skipped when `drsAssist != 0`. ON_TRACK                   | "You have DRS. Attack."                                                                                                                                                                                                                                                                                                                                                         | HIGH                      |
| `LapCountdown`                 | On a lap-up tick where laps remaining == 10, 3, or 1                                                                      | 10: "10 laps remaining. Keep it clean, manage your tyres." / 3: "3 laps to go. Bring it home." / 1: "Last lap. Give it everything you've got."                                                                                                                                                                                                                                  | IMMEDIATE                 |
...
| Detector                   | Trigger Condition                                                                                                           | Message Pattern                                                                                                                                                                  | Priority |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `PracticeTyreFuelSummary`  | Every 4 laps (from lap 2). ON_TRACK                                                                                         | "Fronts at {n}% wear, rears at {m}%, fuel for {z} more laps." (falls back to "fuel {kg} kilograms" when `fuelLaps` is 0)                                                         | NORMAL   |
...
| RTMT  | Car retirement event received      | "{name} has retired." ("A car has retired." when no driver name)                   | NORMAL    |
