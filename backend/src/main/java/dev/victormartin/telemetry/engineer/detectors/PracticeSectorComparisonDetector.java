 ...
 *
 * A 150ms deficit and 3-lap cooldown is too coarse for a Free Practice
 * driving session and never fired in the captured run (Phase C bug 3.4).
 *
 * Tuning:
 * - deficit threshold: 100ms
 * - cooldown: 1 lap
 */
