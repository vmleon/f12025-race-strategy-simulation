 ...
 *
 * Firing immediately on any position change spams the radio with "lost a
 * place / gained / lost again" in quick succession during a battle. So this
 * buffers changes for {@link #DEBOUNCE_MS} of stable position before emitting
 * a single message that reports the *net* change against the pre-battle
 * baseline:
 *
