 ...
 *
 * Replaces v1 detectSessionTrackTraffic. The v1 detector ran every time
 * pitStatus was non-zero, which meant it fired on pit ENTRY (the moment the
 * player crossed into the pit lane) instead of pit EXIT. Phase C bugs 3.1, 3.3.
 *
 * v2 fix: declare {@code appliesToStates = {PIT_EXIT}}. The orchestrator will
 * not call this detector unless the player is in PIT_EXIT.
 */
